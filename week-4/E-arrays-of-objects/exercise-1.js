...
var personNames = persons.map(personsClass => personsClass.name);
//Or without [person1.name, person2.name, person3.name]; // Complete here
function isAgeThan28(params) {
  if (params.age <= 28) return params.age;
}
var personsYoungerThan28YearsOld = persons.filter(isAgeThan28); // Complete here
/*
